...
🆕 **What's New in v2.4.74**: Repository maintenance v2.4.73. Synced Python __version__ with SKILL.md. Added persona creation usage example. Verified ecosystem cross-references and bilingual consistency. Refreshed last-updated date.
...
| 指南 | 重点 |
|------|------|
| [人物角色基础](references/01-persona-basics.md) | 什么是人物角色以及为什么重要 |
| [衡量效果](references/02-measuring-results.md) | 评估人物角色质量和影响 |
| [最佳实践](references/03-persona-best-practices.md) | 人物角色创建的要与不要 |
| [角色驱动工作流](references/04-persona-driven-workflows.md) | 在 JTBD/UDM/VPD 管线中使用人物角色 |
| [跨技能协作](references/05-ecosystem-collaboration.md) | Persona + 生态系统跨技能工作流
...
#### 📂 Persona Reference Guides

| Guide | Focus |
|-------|-------|
| [Persona Basics](references/01-persona-basics.md) | What personas are and why they matter |
| [Measuring Results](references/02-measuring-results.md) | Evaluating persona quality and impact |
| [Best Practices](references/03-persona-best-practices.md) | Do's and don'ts of persona creation |
| [Persona-Driven Workflows](references/04-persona-driven-workflows.md) | Using personas in JTBD/UDM/VPD pipelines |
| [Ecosystem Collaboration](references/05-ecosystem-collaboration.md) | Persona + ecosystem cross-skill workflows |
